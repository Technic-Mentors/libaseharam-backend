...
import { reviewIdParamSchema, listAdminReviewsQuerySchema, adminReviewSchema } from '../../validation/review.schema.js';

export const reviewsRouter = Router();

reviewsRouter.use(requireAdmin);
reviewsRouter.get('/', validate(listAdminReviewsQuerySchema), reviewsController.list);
reviewsRouter.post('/', validate(adminReviewSchema), reviewsController.create);
